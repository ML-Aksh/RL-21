...
class ModelEnv:
    ...
    def set_noise(self, noise_threshhold):
        self.noise_level = noise_threshhold
    ...
    def step(
        ...
        with torch.no_grad():
            ...
            mean = torch.zeros_like(next_observs)
            randomness = torch.normal(mean.float(), self.noise_level)
            next_observs += randomness
